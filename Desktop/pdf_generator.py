...
def uploader_et_lier_pdf(local_pdf_path, devis_id):
    try:
...
def generer_pdf_devis(devis_id, output_path="devis_temp.pdf"):
    ...
    if logo_path:
        try:
            ...
            print("[PDF LOGO] ✓ Logo inséré depuis le dossier local")
        except Exception as e:
    ...
    uploader_et_lier_pdf(output_path, devis_id)
